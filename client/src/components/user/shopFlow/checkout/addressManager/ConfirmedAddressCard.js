        ...
        {address.flaggedForRemoval ? (
          <>
            <Typography variant="body2">
              <strong>Really delete this address?</strong>
            </Typography>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <PrimaryButton
                title="CANCEL"
                onClick={() =>
                  setDeleteFlagOfSpecifiedAddress(address._id, false)
                }
                outlined
              />
            </div>
          ...
          <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <IconButton
                onClick={() =>
                  setDeleteFlagOfSpecifiedAddress(address._id, true)
                }
              >
                <Icon>
                  <DeleteForever />
